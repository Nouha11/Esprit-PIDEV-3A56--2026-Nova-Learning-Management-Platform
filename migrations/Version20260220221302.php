 ...
 */
final class Version20260220221302 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, type VARCHAR(50) NOT NULL, difficulty VARCHAR(50) NOT NULL, category VARCHAR(50) NOT NULL, token_cost INT NOT NULL, energy_points INT DEFAULT NULL, reward_tokens INT NOT NULL, reward_xp INT NOT NULL, is_active TINYINT NOT NULL, created_at DATETIME NOT NULL, user_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_232B318C5E237E06 (name), INDEX IDX_232B318CA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE game_rating (id INT AUTO_INCREMENT NOT NULL, rating INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, game_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_A5BC8BEAE48FD905 (game_id), INDEX IDX_A5BC8BEAA76ED395 (user_id), UNIQUE INDEX unique_user_game_rating (game_id, user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, upvotes INT NOT NULL, created_at DATETIME NOT NULL, is_locked TINYINT NOT NULL, author_id INT NOT NULL, INDEX IDX_5A8A6C8DF675F31B (author_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE report (id INT AUTO_INCREMENT NOT NULL, reason VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, post_id INT NOT NULL, reporter_id INT NOT NULL, INDEX IDX_C42F77844B89032C (post_id), INDEX IDX_C42F7784E1CFE6F5 (reporter_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE student_profile (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, email VARCHAR(180) DEFAULT NULL, bio LONGTEXT DEFAULT NULL, university VARCHAR(100) DEFAULT NULL, major VARCHAR(100) DEFAULT NULL, academic_level VARCHAR(50) DEFAULT NULL, profile_picture VARCHAR(255) DEFAULT NULL, interests JSON DEFAULT NULL, total_xp INT NOT NULL, total_tokens INT NOT NULL, level INT NOT NULL, UNIQUE INDEX UNIQ_6C611FF7E7927C74 (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(100) NOT NULL, role VARCHAR(50) NOT NULL, is_active TINYINT NOT NULL, is_verified TINYINT DEFAULT 0 NOT NULL, verification_token VARCHAR(255) DEFAULT NULL, verification_token_expires_at DATETIME DEFAULT NULL, reset_password_token VARCHAR(255) DEFAULT NULL, reset_password_token_expires_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, xp INT DEFAULT 0 NOT NULL, student_profile_id INT DEFAULT NULL, tutor_profile_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D6492125FF59 (student_profile_id), UNIQUE INDEX UNIQ_8D93D649430AF9E (tutor_profile_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user_favorite_games (user_id INT NOT NULL, game_id INT NOT NULL, INDEX IDX_222EDF4CA76ED395 (user_id), INDEX IDX_222EDF4CE48FD905 (game_id), PRIMARY KEY (user_id, game_id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE game_rating ADD CONSTRAINT FK_A5BC8BEAE48FD905 FOREIGN KEY (game_id) REFERENCES game (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE game_rating ADD CONSTRAINT FK_A5BC8BEAA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game_rating DROP FOREIGN KEY FK_A5BC8BEAE48FD905');
        $this->addSql('ALTER TABLE game_rating DROP FOREIGN KEY FK_A5BC8BEAA76ED395');
