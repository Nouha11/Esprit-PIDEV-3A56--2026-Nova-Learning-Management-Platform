 ...
 */
final class Version20260222202654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE enrollment_requests (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(50) NOT NULL, requested_at DATETIME NOT NULL, responded_at DATETIME DEFAULT NULL, message LONGTEXT DEFAULT NULL, student_id INT NOT NULL, course_id INT NOT NULL, responded_by_id INT DEFAULT NULL, INDEX IDX_604AFC41CB944F1A (student_id), INDEX IDX_604AFC41591CC992 (course_id), INDEX IDX_604AFC41296135A7 (responded_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE user_sessions (id INT AUTO_INCREMENT NOT NULL, session_token VARCHAR(255) NOT NULL, ip_address VARCHAR(45) DEFAULT NULL, user_agent VARCHAR(255) DEFAULT NULL, browser VARCHAR(100) DEFAULT NULL, platform VARCHAR(100) DEFAULT NULL, device VARCHAR(100) DEFAULT NULL, location VARCHAR(100) DEFAULT NULL, created_at DATETIME NOT NULL, last_activity DATETIME NOT NULL, is_active TINYINT NOT NULL, is_current TINYINT NOT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_7AED7913844A19ED (session_token), INDEX IDX_7AED7913A76ED395 (user_id), INDEX idx_user_active (user_id, is_active), INDEX idx_session_token (session_token), INDEX idx_last_activity (last_activity), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE enrollment_requests ADD CONSTRAINT FK_604AFC41CB944F1A FOREIGN KEY (student_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE enrollment_requests ADD CONSTRAINT FK_604AFC41591CC992 FOREIGN KEY (course_id) REFERENCES course (id)');
        $this->addSql('ALTER TABLE enrollment_requests ADD CONSTRAINT FK_604AFC41296135A7 FOREIGN KEY (responded_by_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE enrollment_requests DROP FOREIGN KEY FK_604AFC41CB944F1A');
        $this->addSql('ALTER TABLE enrollment_requests DROP FOREIGN KEY FK_604AFC41591CC992');
        $this->addSql('ALTER TABLE enrollment_requests DROP FOREIGN KEY FK_604AFC41296135A7');
        $this->addSql('ALTER TABLE notifications DROP FOREIGN KEY FK_6000B0D3A76ED395');
        $this->addSql('ALTER TABLE user_sessions DROP FOREIGN KEY FK_7AED7913A76ED395');
        $this->addSql('DROP TABLE enrollment_requests');
        ...
        $this->addSql('DROP INDEX IDX_BC91F416591CC992 ON resource');
        $this->addSql('ALTER TABLE resource DROP course_id, CHANGE study_session_id study_session_id INT NOT NULL');
        $this->addSql('ALTER TABLE reward CHANGE icon icon VARCHAR(255) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE student_profile DROP energy, CHANGE email email VARCHAR(180) DEFAULT \'NULL\', CHANGE university university VARCHAR(100) DEFAULT \'NULL\', CHANGE major major VARCHAR(100) DEFAULT \'NULL\', CHANGE academic_level academic_level VARCHAR(50) DEFAULT \'NULL\', CHANGE profile_picture profile_picture VARCHAR(255) DEFAULT \'NULL\', CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\', CHANGE interests interests LONGTEXT DEFAULT NULL COLLATE `utf8mb4_bin`');
        $this->addSql('ALTER TABLE study_session CHANGE ended_at ended_at DATETIME DEFAULT \'NULL\', CHANGE completed_at completed_at DATETIME DEFAULT \'NULL\', CHANGE mood mood VARCHAR(20) DEFAULT \'NULL\', CHANGE energy_level energy_level VARCHAR(20) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE study_streak CHANGE last_study_date last_study_date DATE DEFAULT \'NULL\'');
