...
| Route | Method | Description | Access |
|-------|--------|-------------|--------|
| `/analytics` | GET | View analytics dashboard | ROLE_STUDENT |
| `/analytics?range=week` | GET | Weekly analytics | ROLE_STUDENT |
| `/analytics?range=month` | GET | Monthly analytics | ROLE_STUDENT |
| `/analytics?range=year` | GET | Yearly analytics | ROLE_STUDENT |
...
| Route | Method | Description | Access |
|-------|--------|-------------|--------|
| `/study-session/{id}/resource/list` | GET | List session resources | ROLE_STUDENT |
| `/study-session/{id}/resource/upload` | GET, POST | Upload PDF resource | ROLE_STUDENT |
| `/study-session/{id}/resource/{resourceId}/download` | GET | Download PDF resource | ROLE_STUDENT |
| `/study-session/{id}/resource/{resourceId}/delete` | POST | Delete resource | ROLE_STUDENT |
